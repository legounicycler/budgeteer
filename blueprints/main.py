...
def data_reload():
  try:
    ...
    data['account_select_options_special_html'] = render_template('account_select_options_special.html', accounts_data=accounts_data, special=True)
    ...
    data['envelope_select_options_special_html'] = render_template('envelope_select_options_special.html', envelopes_data=envelopes_data, special=True)
